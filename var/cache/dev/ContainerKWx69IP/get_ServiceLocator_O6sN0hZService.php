...
class get_ServiceLocator_O6sN0hZService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['.service_locator.o6sN0hZ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'doctrine' => ['privates', '.errored..service_locator.o6sN0hZ.Doctrine\\Persistence\\ManagerRegistry', NULL, 'Cannot autowire service ".service_locator.o6sN0hZ": it references interface "Doctrine\\Persistence\\ManagerRegistry" but no such service exists. Did you create a class that implements this interface?'],
        ], [
